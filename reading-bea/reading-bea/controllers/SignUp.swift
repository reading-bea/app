...
class SignUp: UIViewController {
    ...
    @IBOutlet weak var iconEmailTextField: UITextField! {
        didSet {
            iconEmailTextField.layer.cornerRadius = 10
            iconEmailTextField.tintColor = Colours.baseBlack
            iconEmailTextField.setIcon(UIImage(imageLiteralResourceName: "email"))
        }
    }
